...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1286: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1287: x0 => x0.decode(),
      _1288: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1289: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1319: s => JSON.stringify(s),
      _1320: s => printToConsole(s),
      _1321: (o, p, r) => o.replaceAll(p, () => r),
      _1322: (o, p, r) => o.replace(p, () => r),
      _1323: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1324: s => s.toUpperCase(),
      _1325: s => s.trim(),
      _1326: s => s.trimLeft(),
      _1327: s => s.trimRight(),
      _1328: (string, times) => string.repeat(times),
      _1329: Function.prototype.call.bind(String.prototype.indexOf),
      _1330: (s, p, i) => s.lastIndexOf(p, i),
      _1331: (string, token) => string.split(token),
      _1332: Object.is,
      _1333: (a, i) => a.push(i),
      _1337: a => a.pop(),
      _1338: (a, i) => a.splice(i, 1),
      _1339: (a, s) => a.join(s),
      _1340: (a, s, e) => a.slice(s, e),
      _1342: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1343: a => a.length,
      _1345: (a, i) => a[i],
      _1346: (a, i, v) => a[i] = v,
      _1348: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1349: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1350: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1352: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      ...
      _1358: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1359: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1360: (t, s) => t.set(s),
      _1361: l => new DataView(new ArrayBuffer(l)),
      _1362: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1364: o => o.buffer,
      _1365: o => o.byteOffset,
      _1366: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1367: (b, o) => new DataView(b, o),
      _1368: (b, o, l) => new DataView(b, o, l),
      _1369: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1370: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1371: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1372: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1373: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1374: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1375: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1376: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1377: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1378: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1379: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1380: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1383: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1384: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1385: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1386: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1387: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1388: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1407: (handle) => clearTimeout(handle),
      _1408: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1409: (handle) => clearInterval(handle),
      _1410: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1411: () => Date.now(),
      _1412: () => new AbortController(),
      _1413: x0 => x0.abort(),
      _1414: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1415: (x0,x1) => globalThis.fetch(x0,x1),
      _1416: (x0,x1) => x0.get(x1),
      _1417: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1417(f,arguments.length,x0,x1,x2) }),
      _1418: (x0,x1) => x0.forEach(x1),
      _1419: x0 => x0.getReader(),
      _1420: x0 => x0.read(),
      _1421: x0 => x0.cancel(),
      _1444: (s, m) => {
        try {
      ...
      _1445: (x0,x1) => x0.exec(x1),
      _1446: (x0,x1) => x0.test(x1),
      _1447: x0 => x0.pop(),
      _1449: o => o === undefined,
      _1451: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1453: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1454: o => o instanceof RegExp,
      _1455: (l, r) => l === r,
      _1456: o => o,
      _1457: o => o,
      _1458: o => o,
      ...
      _1460: o => o.length,
      _1462: (o, i) => o[i],
      _1463: f => f.dartFunction,
      _1464: () => ({}),
      _1465: () => [],
      _1467: () => globalThis,
      _1468: (constructor, args) => {
      ...
      _1470: (o, p) => o[p],
      _1471: (o, p, v) => o[p] = v,
      _1472: (o, m, a) => o[m].apply(o, a),
      _1474: o => String(o),
      _1475: (p, s, f) => p.then(s, f),
      _1476: o => {
      ...
      _1477: o => [o],
      _1478: (o0, o1) => [o0, o1],
      _1479: (o0, o1, o2) => [o0, o1, o2],
      _1480: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1495: x0 => x0.groups,
      _1496: x0 => x0.flags,
      _1497: x0 => x0.multiline,
      _1498: x0 => x0.ignoreCase,
      _1499: x0 => x0.unicode,
      _1500: x0 => x0.dotAll,
      _1501: (x0,x1) => x0.lastIndex = x1,
      _1502: (o, p) => p in o,
      _1503: (o, p) => o[p],
      _1506: x0 => x0.random(),
      _1507: (x0,x1) => x0.getRandomValues(x1),
      _1508: () => globalThis.crypto,
      _1509: () => globalThis.Math,
      _1510: Function.prototype.call.bind(Number.prototype.toString),
      _1511: Function.prototype.call.bind(BigInt.prototype.toString),
      _1512: Function.prototype.call.bind(Number.prototype.toString),
      _1513: (d, digits) => d.toFixed(digits),
      _1517: () => globalThis.document,
      _1537: x0 => x0.src,
      _1538: (x0,x1) => x0.src = x1,
      _1539: x0 => x0.naturalWidth,
      _1540: x0 => x0.naturalHeight,
      _1556: x0 => x0.status,
      _1557: (x0,x1) => x0.responseType = x1,
      _1559: x0 => x0.response,
      _3391: () => globalThis.window,
      _3453: x0 => x0.navigator,
      _3842: x0 => x0.userAgent,
      _5997: x0 => x0.signal,
      _7833: x0 => x0.value,
      _7835: x0 => x0.done,
      _8537: x0 => x0.url,
      _8539: x0 => x0.status,
      _8541: x0 => x0.statusText,
      _8542: x0 => x0.headers,
      _8543: x0 => x0.body,
      _12171: x0 => x0.name,
...
"mime",
"image/svg+xml",
"^(?<scheme>data):(?<mime>image/[\\w+\\-.]+);*(?<encoding>base64)?,\\s*(?<data>.*)",
".svg",
"IQ==",
"*{",
"dashed",
